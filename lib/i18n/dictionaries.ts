...
export type StorefrontDictionary = {
  ...
  product: { addToCart: string; selectVariant: string; selectSize: string; selectColor: string; size: string; color: string; category: string; vatIncluded: string; gallery: string; soldOut: string; unavailablePreview: string; savings: string };
...
const ar: StorefrontDictionary = {
  ...
  product: { addToCart: "أضف إلى السلة", selectVariant: "اختر اللون والمقاس", selectSize: "اختر المقاس", selectColor: "اختر اللون", size: "المقاس", color: "اللون", category: "حذاء", vatIncluded: "شامل الضريبة", gallery: "صور المنتج", soldOut: "نفد المخزون", unavailablePreview: "لا توجد صورة لـ", savings: "وفّر {amount}" },
