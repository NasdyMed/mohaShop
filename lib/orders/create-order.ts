    ...
    db.$transaction(async (transaction) => {
        ...
        await transaction.order.create({
          data: {
            ...
            customerAddressComplement: checkout.addressComplement,
            customerCity: checkout.city,
            customerRegion: checkout.region,
            customerPostalCode: checkout.postalCode,
            customerCountry: checkout.country,
