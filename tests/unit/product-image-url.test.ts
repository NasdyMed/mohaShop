...
const base={name:"Bottes",description:"Description suffisamment longue.",priceDh:500,slug:"bottes",isVisible:false,variants:[]};
const parse=(url:string)=>productInputSchema.safeParse({...base,images:[{url,alt:"Botte",position:0}]}).success;
